...
jQuery(document).ready(function(){
    ...
    if( jQuery('#fullPage').width() > 0 ){
        jQuery("#fullPage").fullpage({
            ...
            anchors: ['platform', 'platform-subsection', 'platform-subsection', 'token-view', 'token-view-subsection', 'roadmap', 'team', 'trending', 'partners', 'app', 'faq', 'contact'],
    ...
    jQuery('.settings-btn').on('click', function(){
        ...
        jQuery('.settings-box').toggleClass('align-items-end visible');
    });
...
jQuery('.hex-content .frow, .hex-content .divc, .hex-content .coma, .hex-content .sown, .hex-content .bura, .hex-content .lehi, .hex-content .mydiv, .hex-content .vice, .hex-content .poll, .hex-content .lefty, .hex-content .kiwi, .hex-content .libeled, .hex-content .fitz, .hex-content .classy').remove();
jQuery('.settings-btn .divc, .settings-btn .kiwi, .settings-btn .classy, .settings-btn .sown, .settings-btn .lefty, .settings-btn .vice, .settings-btn .coma, .settings-btn .bura').remove();
jQuery('.btn-color .mydiv, .btn-color .kiwi, .btn-color .lefty, .btn-color .classy, .btn-color .vice, .btn-color .coma, .btn-color .poll, .btn-color .bura, .btn-color .fitz, .btn-color .sown, .btn-color .divc, .btn-color .frow, .btn-color .libeled, .btn-color .lehi').remove();
jQuery('.navbar-toggler .lefty, .navbar-toggler .fitz, .navbar-toggler .frow, .navbar-toggler .bura, .navbar-toggler .libeled, .navbar-toggler .classy, .navbar-toggler .coma, .navbar-toggler .mydiv, .navbar-toggler .vice, .navbar-toggler .poll').remove();
